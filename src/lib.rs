...
#[derive(Debug)]
pub struct AlertTriggerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AlertTriggerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AlertTrigger processing");
    
    let mut processor = AlertTriggerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AlertTriggerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AlertTriggerProcessor::new(false);
